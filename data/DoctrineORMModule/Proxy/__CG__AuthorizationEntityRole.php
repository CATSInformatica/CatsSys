...
class Role extends \Authorization\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Authorization\\Entity\\Role' . "\0" . 'roleId', '' . "\0" . 'Authorization\\Entity\\Role' . "\0" . 'roleName', '' . "\0" . 'Authorization\\Entity\\Role' . "\0" . 'user', '' . "\0" . 'Authorization\\Entity\\Role' . "\0" . 'role');
        }
