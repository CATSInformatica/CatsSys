...
return array(
   ...
   // Zend\Validator\File\Size
    ...
    // Recruitment\Validator\Cpf
    "Invalid Cpf" => "O Cpf não é válido",
    "Invalid format. The only valid format is XXX.XXX.XXX-XX" => "O formato válido é XXX.XXX.XXX-XX",
    
    // Recruitment\Validator\DateGratherThan
    "The input is not greater than '%minimumName%'" => "O valor de entrada não é maior do que '%minimumName%'",
    "The input is not greater or equal than '%minimumName%'" => "O valor de entrada não é maior ou igual a '%minimumName%'",
);
