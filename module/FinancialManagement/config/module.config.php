...
return array(
    'controllers' => array(
        'invokables' => array(
            'FinancialManagement\Controller\CashFlow' => Controller\CashFlowController::class,
            'FinancialManagement\Controller\Patrimony' => Controller\PatrimonyController::class,
        ),
    ),
    'router' => array(
        'routes' => array(
                ...
                'child_routes' => array(
                    ...
                    'patrimony' => array(
                        ...
                        'options' => array(
                            ...
                            'defaults' => array(
                                'controller' => 'FinancialManagement\Controller\Patrimony',
                                'action' => 'index',
                            ),
                        ),
                    ),
        ...
        'default' => array(
            array(
                ...
                'pages' => array(
                    ...
                    array(
                        'label' => 'Patrimony',
                        'route' => 'financial-management/patrimony',
                        'action' => 'index',
                        'resource' => 'FinancialManagement\Controller\Patrimony',
                        'privilege' => 'index',
                        'icon' => 'fa fa-list-ul',
                    ),
                ),
